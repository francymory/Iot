...
# Definizione della specifica Swagger
swagger_spec = {
    "openapi": "3.0.0",
    "info": {
...
# Resto del tuo codice per le API
...
def ricevi_richiesta():
    ...
    cad_non_bool = int(dati_richiesta.get('caduta'))
    ...
    print(f'stampa prova: ho ricevuto da identifier={identifier}, latitude={latitude}, longitude={longitude}, caduta={caduta}, cad={cad_non_bool}')
